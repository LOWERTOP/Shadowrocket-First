...
> [!NOTE]
> 本单元为自制内容，仅为 ` 特定的软件或服务 ` 所用，如无需要可直接略过
...
> [!TIP]
> **小火箭配色文件使用说明**
> * 选择所需配色，在链接代码 ` shadowrocket://color?* ` 右侧点击 “ ❐ ” 符号复制链接，在 ` 配置 ` 页面点击 “ ✚ ” 号，粘贴链接并应用
> * 恢复默认颜色设置 ` APP 设置-颜色-重设颜色 `

> [!IMPORTANT]
> * 小火箭配色文件是作者使用 Shadowrocket APP 内建的 ` 颜色 `功能逐步调教的各种配色方案，作者的目标是基于官方接口尽量调配出尽可能满足各种需求的配色/主题/皮肤，为该 APP 适当“提升”颜值
...
> * 反馈入口：[Shadowrocket Telegram 频道 ](https://t.me/ShadowrocketApp)
> * 更新时间：` 2024年11月12日 `
> * 配色数量：` 18 `
...
> [!CAUTION]
> 以下为已完成的小火箭配色文件，如需转载请务必 ` 注明来源 ` 或 ` 标明作者 ` 以尊重作者劳动成果
...
> [!TIP]
> 可将示例配色链接交给 AI 进行随机/按要求搭配，或许有意外 ~~惊吓~~ 惊喜
