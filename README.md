...
> [!NOTE]
> 
> 本仓库主要提供 `Shadowrocket/小火箭` 相关内容，包含多种 `配置文件` `模块` `规则集` `脚本` 等配置，同时提供多种原创 `小火箭配色/主题/皮肤`。若有软件使用疑问可查看 **[使用手册](https://github.com/LOWERTOP/Shadowrocket)**
>
