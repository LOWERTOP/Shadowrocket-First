...
> * 反馈入口：[Shadowrocket Telegram 官方频道 ](https://t.me/ShadowrocketApp)
> * 更新时间： ` 2024年11月12日 `
> * 配色数量： ` 18 `
...
> [!NOTE]
> 小火箭自定义配色使用十六进制色值进行调整，用户可根据自己需要进行自定义，以下为小火箭配色描述的中文翻译，如有需要可自行对照调整

> [!TIP]
> 可将示例配色链接交给 AI 进行随机/按要求搭配，或许可以有意外惊喜（惊吓）
