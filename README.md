...
> [!NOTE]
> 
> 本仓库主要提供 `Shadowrocket/小火箭` 相关内容，包含多种 `配置文件` `模块` `规则集` `脚本` 等配置，同时提供多种自主设计的 `小火箭配色/主题/皮肤`。若有软件使用疑问可查看 **[使用手册](https://github.com/LOWERTOP/Shadowrocket)**
>
...
>
> **[向晚融合模块](https://raw.githubusercontent.com/XiangwanGuan/Shadowrocket/main/Module.sgmodule)**：由 [XiangwanGuan 向晚](https://github.com/XiangwanGuan) 维护，基于 `墨鱼去广告模块` 定制，重定义部分功能，由生成器每日自动构建，详情可参阅 [发布页](https://github.com/XiangwanGuan/Shadowrocket)
>   
...
> 
> [![模块检索 模块大合集](https://img.shields.io/static/v1?label=模块检索&message=模块大合集&color=grey&logo=dask&logoColor=white&labelColor=blue&messageColor=white)](https://shadowrocket.module.huksy88.sbs "点击查看模块")
> 
