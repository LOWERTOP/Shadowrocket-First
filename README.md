...
* Shadowrocket Chrome 配色（深灰色）【暗底色】
...
* Shadowrocket BlueSky 配色（深蓝色）【暗底色】
...
* Shadowrocket GodenDark 配色（暗金色）【暗底色】
...
* Shadowrocket Fluoresce 配色（荧光色）【暗底色】
