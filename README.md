...
* Shadowrocket BrightGold 亮金色 `浅底色`
...
* Shadowrocket GodenDark 暗金色 `暗底色`
...
* Shadowrocket Fluoresce 荧光色 `暗底色`
...
> ✨注意：因苹果系统限制，Shadowrocket APP 内部分细节图标不可自定义色彩，且会根据系统深色/浅色模式改变，使用自定义配色时可能会因为此特性导致局部细节图标可视度过高或过低，使用 `暗底色` 时搭配系统深色模式效果最佳，望知悉
