...
> 
> > 本模块由 [iab0x00](https://github.com/iab0x00) 维护，支持去除该软件的各类广告并提供画中画功能，同时支持 Youtube Music 去广告。本模块支持 **参数编辑**，安装后可点击模块进入参数编辑页面，自行调整参数设置。需要注意，Apple TV 版 YouTube 不支持解密，不可使用类似模块
> >   
