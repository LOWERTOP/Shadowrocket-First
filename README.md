...
> [!NOTE]
> 本单元为小火箭配色文件相关内容。项目出发点是作者在使用小火箭的过程中对小火箭的配色逐渐感到单调，借助本身是设计出身，遂制作了几个配色文件，没想到反响挺好，后就借助 GitHub 平台逐步发布的十数种自己设计的配色文件，以供大家挑选使用
...
> * __快捷指令安装：__ [点击安装快捷指令](https://www.icloud.com/shortcuts/f48502da18d845dbae8735cea571d709)，在快捷指令中选择配色并安装
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=BrightGold)
> 
> <details>
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=V2EXDay)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=EcoGreen)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=IceCream)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=Elegant)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=Cloudy)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=AyuLight)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=Solarized)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=LightOwl)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=SnowTop)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=Chrome)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=BlueSky)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=GodenDark)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=Fluoresce)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=TermiusDark)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=Sunset)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=Rose)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=Violet)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=KanagawaWave)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=KanagawaGray)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=CyberPurple)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> ```
> [点击此处一键安装](https://lowertop.github.io/Shadowrocket-First/theme.html?target=V2EXNight)
> 
> <details>
> <summary>效果截图</summary>
> 
...
> [!NOTE]
> 本单元为 URL Redirector 非标准链接重定向跳转相关内容

> 本服务的出发点是作者在使用 ` GitHub ` 进行小火箭相关配置设置期间，发现本页不能使用 ` URL-Schemes ` 的链接作为超链一键安装，也就是本页不支持非标准链接的超链，遂萌生了使用 ` HTML ` 进行跳转的想法，后经 ` GPT ` 帮助实现本单元初步设想
