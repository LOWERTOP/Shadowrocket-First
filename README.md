...
>> * __` 仓库 `__ : 由于小火箭兼容性比较强，模块可选择类型也很多，本文推荐 [app2smile](https://github.com/app2smile) 、[QingRex](https://github.com/QingRex) 、[可莉](https://github.com/luestr/ProxyResource) 等模块作者，可以自行进他们的仓库进行挑选。本文不保证可用性，某些模块的生效或者完全生效需要使用 [插件](https://raw.githubusercontent.com/Script-Hub-Org/Script-Hub/main/modules/script-hub.rocket.module) 进行转换
