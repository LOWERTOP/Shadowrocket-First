...
> >   
> > [![安装模块 比价折线版](https://img.shields.io/static/v1?label=安装模块&message=比价折线版&color=grey&logo=educative&logoColor=white&labelColor=blue&messageColor=white)](https://lowertop.dpdns.org/redirect.html?url=shadowrocket://install?module=https://github.com/githubdulong/Script/blob/master/Surge/jd_price.sgmodule "一键安装本模块")
> > [![安装模块 比价表格版](https://img.shields.io/static/v1?label=安装模块&message=比价表格版&color=grey&logo=educative&logoColor=white&labelColor=blue&messageColor=white)](https://lowertop.dpdns.org/redirect.html?url=shadowrocket://install?module=https://github.com/githubdulong/Script/blob/master/Surge/jd_price2.sgmodule "一键安装本模块")
>  
